...
<head>
  ...
  <title>Pagination | Docs | Metaphor by META+Lab</title>
      ...
      <div class="row">
        <div class="col-sm-12">
          ...
          <ul class="breadcrumbs breadcrumbs--marginless type--white">
            ...
            <li class="breadcrumb__item">Pagination</li>
          </ul>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        ...
        <div class="col-sm-3">
          ...
          <ul class="nav">
            ...
            <li class="nav__item nav__item--active"><a class="nav__link" href="pagination.html">Pagination</a></li>
